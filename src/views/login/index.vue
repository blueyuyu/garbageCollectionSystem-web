  ...
  <div class="base" style="position: relative">
    ...
    <div class="loginAndRegist">
      ...
      <div class="popover" v-show="showDialog">
        <div class="checkHua">
          <i
            ...
            class="el-icon-close fs-18"
          ></i>
          <div style="z-index: 2147483647; transform: translate(-59px, 273px)">
            {{ msg }}
          </div>
        </div>
        <slide-verify
      ...
      <div class="loginArea">
        ...
        >
          <!-- 标语 -->
          <div v-show="isShow" class="title">登录</div>
        </transition>
        <transition
          name="animate__animated animate__bounce"
          enter-active-class="animate__fadeInUp"
        ...
        >
          ...
          <div v-show="isShow" class="btnArea">
            <el-button
              type="primary"
              round
              style="background-color: #409eff; letter-spacing: 5px"
              @click="UserLogin"
              >登录
            </el-button>
          </div>
        ...
        >
          ...
          <div v-show="!isShow" class="registForm">
            ...
            <div
              ...
              "
            >
              密{{ "\xa0" }}{{ "\xa0" }}{{ "\xa0" }}{{ "\xa0" }}{{ "\xa0"
              }}{{ "\xa0" }}{{ "\xa0" }}{{ "\xa0" }}{{ "\xa0" }}{{ "\xa0" }}码:
              <el-input
                size="medium"
                placeholder="请输入密码"
                style="width: 165px; margin-left: 10px"
          ...
          >
            ...
            <div style="flex: 2">
              <el-button
                type="success"
                style="
                  background-color: rgb(52 143 210);
...
export default {
  ...
  data() {
    return {
      verifyImgs: [img1, img2, img3, img4, img5, img6],
      isShowyan: true,
      showDialog: false,
      msg: "",
      text: "向右滑动验证",
...
.title {
  width: 70%;
  flex: 1;
  border-bottom: 1px solid var(--login-fontColor);
  display: flex;
  align-items: center;
  color: var(--login-fontColor);
  font-weight: bold;
  font-size: 24px;
  display: flex;
  justify-content: center;
...
.pwdArea input:focus {
  border: 2px solid var(--login-fontColor);
}
