        ...
        <div data-fetch-key="0" class="app light macwk-animation">
          ...
          <div class="layout-min-full-height">
            <div class="macwk-about-section">
              ...
              <img
                src="../static/picture/alfred-powerpack.png"
                alt=""
                class="people"
              />
              ...
              <div class="container">
                ...
                <p class="sub-title text-center fs-20">
                  只提供精品资源，站长款款测试，免费、安全、无广告、不限速。
                </p>
                  ...
                  <div class="main-content">
                    <div class="macwk-about-slider">
                      <div class="item">
                        <p>
                          在
                          <span class="fw-600 text-primary fs-22"
                            >MacWk.com</span
                          >，
                        </p>
                        <p>立即下载</p>
              ...
              <div class="sidetools-item">
                <div class="sidetools-wrapper">
                  <a class="el-tooltip cursor"
                    ><span class="sidetools-icon back-top"
                  /></a>
                </div>
              </div>
              <span>
